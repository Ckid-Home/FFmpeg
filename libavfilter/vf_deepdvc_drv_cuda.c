...
/**
 * @file
 * Color/vibrance-enhancement filter driving the NVIDIA *driver* DeepDVC network
...
const FFFilter ff_vf_deepdvc_drv_cuda = {
    ...
    .p.description  = NULL_IF_CONFIG_SMALL("NVIDIA driver RTX Dynamic Vibrance / DeepDVC (CUDA)"),
